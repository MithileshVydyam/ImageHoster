...
public class ImageController {
    ...
    public String showImage(@PathVariable("id") Integer id,@PathVariable("title") String title, Model model) {
        ...
        List<Comment> comments = imageService.getComments();
        List<Comment> filteredComments = comments.stream().filter(ele -> ele.getImage().getId()==id).collect(Collectors.toList());
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        if(user != null && user.getUsername().equalsIgnoreCase(image.getUser().getUsername())){
            return "images/edit";
        }else{
    ...
    public String postComment(@PathVariable("imageId") Integer imageId,@PathVariable("imageTitle") String imageTitle, @RequestParam("comment") String content, Model model,HttpSession session) {
        ...
        List<Comment> comments = imageService.postComment(comment);
        List<Comment> filteredComments = comments.stream().filter(ele -> ele.getImage().getId()==imageId).collect(Collectors.toList());
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
        model.addAttribute("comments",filteredComments);
        return "images/image";
